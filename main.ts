namespace SpriteKind {
    export const inicio = SpriteKind.create()
    export const JOHN = SpriteKind.create()
    export const COSO = SpriteKind.create()
    export const ONDITAS = SpriteKind.create()
    export const RESURRECTION = SpriteKind.create()
    export const coso1 = SpriteKind.create()
    export const LUZ = SpriteKind.create()
    export const ANGEL = SpriteKind.create()
    export const EM = SpriteKind.create()
    export const PERDISTE = SpriteKind.create()
    export const JOHNCITOUNO = SpriteKind.create()
    export const infernooon = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.JOHN, SpriteKind.EM, function (sprite, otherSprite) {
    game.showLongText("BUENA ELECCIÓN", DialogLayout.Full)
    tiles.setCurrentTilemap(tilemap`level4`)
})
sprites.onOverlap(SpriteKind.JOHN, SpriteKind.COSO, function (sprite, otherSprite) {
    ...
    diosito = sprites.create(img`
        ...
        . . . . f f 1 1 f f . . . . 
        `, SpriteKind.Player)
    diosito.setPosition(146, 7)
    music.play(music.createSong(hex``), music.PlaybackMode.InBackground)
    diosito.setVelocity(-32, 24)
    pause(2000)
    diosito.setVelocity(0, 0)
    JOHN.sayText("DONDE ESTOY?")
    pause(4000)
    diosito.sayText("EN LA ÚNICA DIMENSIÓN QUE REALMENTE EXISTE")
    pause(4000)
    diosito.sayText("LIBRE DE TIEMPO")
    pause(4000)
    diosito.sayText("Y DE LIMITES CORPORALES")
    pause(4000)
    diosito.sayText("PERO DE FORMA RESUMIDA")
    pause(4000)
    diosito.sayText("ESTAS MUERTO")
    pause(4000)
    JOHN.sayText("PERO...QUE ME VA A PASAR AHORA?")
    pause(4000)
    diosito.sayText("CREO QUE YA DEBERIAS SABERLO")
    pause(4000)
    diosito.sayText("NO ES CIERTO JOHN?")
    pause(4000)
    diosito.sayText("IRAS AL INFIERNO")
    pause(4000)
    sprites.destroy(JOHN)
    sprites.destroy(diosito)
    music.play(music.stringPlayable("B B C5 C5 B B A F ", 500), music.PlaybackMode.UntilDone)
    ...
    JOHN = sprites.create(img`
        ...
        . . . f f . . f f . . . . 
        `, SpriteKind.JOHN)
    JOHN.setPosition(46, 6)
    JOHN.setVelocity(0, 39)
    cusu = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.coso1)
    cusu.setPosition(46, 105)
})
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.inicio, function (sprite, otherSprite) {
    sprites.destroy(carro)
    music.play(music.createSoundEffect(WaveShape.Noise, 1568, 2210, 208, 255, 1000, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.UntilDone)
    scene.setBackgroundImage(img`
        
        ...
        `)
    pause(1000)
    music.play(music.createSoundEffect(WaveShape.Sine, 3421, 2637, 255, 169, 2000, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.UntilDone)
    scene.setBackgroundImage(img`
    ...
    scene.setBackgroundImage(img`
        ...
        8888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888
        `)
    music.play(music.createSoundEffect(WaveShape.Sine, 3421, 2637, 255, 169, 2000, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.InBackground)
    pause(200)
    music.play(music.createSoundEffect(WaveShape.Sine, 3421, 2637, 255, 169, 2000, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.InBackground)
    scene.setBackgroundImage(img`
        1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
    ...
    scene.setBackgroundImage(img`
        ...
        `)
    pause(200)
    music.play(music.createSoundEffect(WaveShape.Sine, 3421, 963, 255, 169, 5000, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.InBackground)
    scene.setBackgroundImage(img`
        
    ...
    scene.setBackgroundImage(img`
        ...
        `)
    music.play(music.createSoundEffect(WaveShape.Square, 285, 1, 0, 255, 9999, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.InBackground)
    game.showLongText("PERO...QUE HAY DESPUÉS?", DialogLayout.Top)
    scene.setBackgroundImage(assets.image`uwu`)
    game.showLongText("DESPUÉS DE LA MUERTE??", DialogLayout.Center)
    pause(2000)
    JOHN = sprites.create(img`
        . . . . f f f f . . . . . 
        . . f f f f f f f f . . . 
...
sprites.onOverlap(SpriteKind.JOHN, SpriteKind.coso1, function (sprite, otherSprite) {
    sprites.destroy(TITULO)
    sprites.destroy(cusu)
    JOHN.setVelocity(0, 0)
    JOHN.sayText("ESTO ES UNA LOCURA")
    pause(3000)
    JOHN.sayText("ES CIERTO QUE NUNCA VIVI HONESTAMENTE")
    pause(3000)
    JOHN.sayText("PERO ESTO ES DEMASIADO")
    pause(3000)
    JOHN.sayText("EN ESTE LUGAR")
    pause(3000)
    JOHN.sayText("DUELE EL SIMPLE HECHO DE RESPIRAR")
    pause(3000)
    infernon = sprites.create(img`
        . . . . . f f f . . . . . 
        . . . . . f f f . . . . . 
        . . . . . f f f . . . . . 
        . . . . . f f f . . . . . 
        ...
        . . . . . f f f . . . . . 
        . . . . . f f f . . . . . 
        `, SpriteKind.infernooon)
    infernon.setVelocity(-32, 24)
})
sprites.onOverlap(SpriteKind.JOHNCITOUNO, SpriteKind.PERDISTE, function (sprite, otherSprite) {
    game.setGameOverMessage(false, "GAME OVER!")
})
sprites.onOverlap(SpriteKind.infernooon, SpriteKind.JOHN, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.JOHN, SpriteKind.LUZ, function (sprite, otherSprite) {
    let johncitop: Sprite = null
    music.play(music.createSong(hex``), music.PlaybackMode.InBackground)
    scene.setBackgroundImage(img`
        ...
        `)
    pause(1000)
    JOHN.setPosition(77, 77)
    pause(1000)
    ANGEL = sprites.create(img`
        ........................
        ........................
        ........................
        ........................
        ...
        ........................
        `, SpriteKind.ANGEL)
    ANGEL.setPosition(114, 65)
    pause(1000)
    ANGEL.sayText("TIENES SUERTE JOHN BURN")
    pause(3000)
    ANGEL.sayText("HOY ES UN DIA ESPECIAL")
    pause(3000)
    ANGEL.sayText("DAREMOS LA OPORTUNIDAD DE SALIR DEL INFIERNO A ESTAS POBRES ALMAS")
    pause(3000)
    ANGEL.sayText("Y TU ERES UNA DE ELLAS")
    pause(3000)
    ANGEL.sayText("SIN EMBARGO PARA SALIR DEBES PASAR ALGUNOS DESAFÍOS...")
    pause(3000)
    ANGEL.sayText("Y COMPLETAR UNA MISIÓN")
    pause(3000)
    ANGEL.sayText("QUIERES INTENTARLO? O PREFIERES PERMANECER EN ESTA TORTURA?")
    pause(3000)
    scene.setBackgroundImage(img`
        
        ...
        1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
        `)
    johncitop.setPosition(77, 23)
    controller.moveSprite(johncitop, 100, 100)
    ...
    NO = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.PERDISTE)
    NO.setPosition(112, 95)
})
let NO: Sprite = null
let SI: Sprite = null
let ANGEL: Sprite = null
let LUCECITA: Sprite = null
let infernon: Sprite = null
let ONDA: Sprite = null
let TITULO: Sprite = null
let diosito: Sprite = null
let cusu: Sprite = null
let JOHN: Sprite = null
let carro: Sprite = null
scene.setBackgroundImage(assets.image`uyu`)
carro = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.inicio)
carro.setPosition(112, 55)
carro.setVelocity(-56, 0)
let carro1 = sprites.create(img`
    ...
    . . . . b b f . . . . b b f . . 
    `, SpriteKind.Enemy)
carro1.setPosition(160, 55)
carro1.setVelocity(-89, 0)
let carro2 = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.inicio)
carro2.setVelocity(89, 0)
carro2.setPosition(5, 109)
